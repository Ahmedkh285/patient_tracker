...
class MessagesComposeDoctor extends StatefulWidget {
   const MessagesComposeDoctor({Key? key}) : super(key: key);
        ...
        SizedBox(
            ...
            child: Card(
              ...
              child: TextField(
                  ...
                  onChanged: (value) {
                    if (value.isNotEmpty) {
                      FireBaseHelper().updateDoctorStatus("typing....",Provider.of<MyProvider>(context,listen: false).auth.currentUser!.uid);
                      setState(() {
                        sendChatButton = true;
                      });
                    } else {
